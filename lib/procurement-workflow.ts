...
function documentTextFromSections(
  ...
  const lines = [
    title,
    `Generated by Hackapp Procurement Assistant on ${generatedDate}`,
    "",
...
function providerEmail(
  ...
  const body = [
    `Hello ${provider} team,`,
    "",
    "Hackapp Procurement Assistant is preparing a procurement request and we would like to request a formal quotation.",
    "",
...
export function generateProcurementQuote(
  ...
  const appName = "Hackapp Procurement Assistant"
